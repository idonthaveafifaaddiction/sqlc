...
func pgCatalog() *catalog.Schema {
	...
	s.Funcs = []*catalog.Function{
		...
		},
		{
			...
			ReturnType: &ast.TypeName{Name: "abstime"},
		},
		{
			Name: "abstime",
			Args: []*catalog.Argument{
		...
		},
		{
			...
			Args: []*catalog.Argument{
				{
					Type: &ast.TypeName{Name: "abstime"},
				},
				{
					Type: &ast.TypeName{Name: "abstime"},
				},
		...
		},
		{
			...
			Args: []*catalog.Argument{
				{
					Type: &ast.TypeName{Name: "reltime"},
				},
				{
					Type: &ast.TypeName{Name: "reltime"},
				},
		...
		},
		{
			...
			Args: []*catalog.Argument{
				{
					Type: &ast.TypeName{Name: "tinterval"},
				},
				{
					Type: &ast.TypeName{Name: "tinterval"},
				},
		...
		},
		{
			...
			ReturnType: &ast.TypeName{Name: "tinterval"},
		},
		{
			Name: "mod",
			Args: []*catalog.Argument{
		...
		},
		{
			...
			ReturnType: &ast.TypeName{Name: "reltime"},
		},
		{
			Name: "reltimeeq",
			Args: []*catalog.Argument{
		...
		},
		{
			...
			ReturnType: &ast.TypeName{Name: "smgr"},
		},
		{
			Name: "smgrne",
			Args: []*catalog.Argument{
		...
		{
			Name: "timestamp_izone_transform",
			Args: []*catalog.Argument{
				{
					Type: &ast.TypeName{Name: "internal"},
				},
